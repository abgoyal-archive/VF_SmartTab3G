...
# mingzhi.shen added, begin
ifeq ($(TCL_TABLEET_FEATURE_SWITCH_OPTION),WIFI_ONLY)
MTK_PROJECT_CONFIGS := $(call wildcard2, $(MTK_PROJECT_CONFIGS) mediatek/build/libs/../../config/$(TARGET_PRODUCT)/JrdWifiOnlyConfig.mk)
endif
ifeq ($(TCL_TABLEET_FEATURE_SWITCH_OPTION),3GDATA_SMS)
MTK_PROJECT_CONFIGS := $(call wildcard2, $(MTK_PROJECT_CONFIGS) mediatek/build/libs/../../config/$(TARGET_PRODUCT)/Jrd3GDataSmsConfig.mk)
endif
ifeq ($(TCL_TABLEET_FEATURE_SWITCH_OPTION),3GDATA_ONLY)
MTK_PROJECT_CONFIGS := $(call wildcard2, $(MTK_PROJECT_CONFIGS) mediatek/build/libs/../../config/$(TARGET_PRODUCT)/Jrd3GDataOnlyConfig.mk)
endif
# mingzhi.shen, end

# mingzhi.shen added for PR681457, begin
ifneq ($(TCL_CUSTOMER_CONFIG),)
MTK_PROJECT_CONFIGS += $(call wildcard2, $(MTK_PROJECT_CONFIGS) mediatek/build/libs/../../config/$(TARGET_PRODUCT)/JrdCust$(TCL_CUSTOMER_CONFIG)Config.mk)
endif
# mingzhi.shen for PR681457, end

# mingzhi.shen added for PR681457, begin
ifeq ($(TARGET_BUILD_MMITEST),true)
MTK_PROJECT_CONFIGS += $(call wildcard2, $(MTK_PROJECT_CONFIGS) mediatek/build/libs/../../config/$(TARGET_PRODUCT)/JrdMMIConfig.mk)
endif
# mingzhi.shen for PR681457, end
