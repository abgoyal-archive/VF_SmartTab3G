...
// 2014-4-2 13:43:36 added by dxf; for pop8 camera.
UINT32 HI258_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 HI257S_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
// 2014-4-2 13:45:32 added by dxf; for pop8 camera.
#if defined(HI258_YUV)
    {HI258_SENSOR_ID, SENSOR_DRVNAME_HI258_YUV, HI258_MIPI_YUV_SensorInit},
#endif
 /*[PLATFORM]-Add-BEGIN by TCTSZ.huangjing,2014.07.07,add hi257s and remove gc2035 for pop7kk.
*/
/*[PLATFORM]-Add-BEGIN by TCTSZ.huangjing,2014.06.25,add 2nd source main camera.
CR-702464
*/
/*[PLATFORM]-Add-END by TCTSZ.huangjing*/
/*[PLATFORM]-Add-END by TCTSZ.huangjing*/
...
// 2014-4-2 13:46:46 added by dxf; for pop8 camera.
...
*/
#endif
#if defined(HI257S_YUV)
    {HI257S_SENSOR_ID, SENSOR_DRVNAME_HI257S_YUV, HI257S_YUV_SensorInit}, 
#endif
/*[PLATFORM]-Add-END by TCTSZ.huangjing*/
