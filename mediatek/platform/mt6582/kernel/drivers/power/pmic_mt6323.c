...
extern void (*do_chrdet_in_touch_driver)(void)=NULL;
extern int Enable_BATDRV_LOG;

void set_do_chrdet_in_touch_driver(void (*func)(void))
{
       do_chrdet_in_touch_driver=func; 
}
...
void chrdet_int_handler(void)
{
    ...
    if(do_chrdet_in_touch_driver!=NULL)
           do_chrdet_in_touch_driver();
