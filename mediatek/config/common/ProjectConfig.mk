...
#================================================================================
MTK_PRODUCT_LOCALES=en_US sq_AL es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB
...
MMI_HUIDING_TP_SUPPORT = no
MMI_IR_SUPPORT = no
MMI_HALL_SUPPORT = no
MMI_DUNTAI_TP_SUPPORT = no
MMI_PSENSOR_SUPPORT = no
MMI_NAME_PIXO7_SUPPORT = no
MMI_TP_POP7KK_SUPPORT = no
